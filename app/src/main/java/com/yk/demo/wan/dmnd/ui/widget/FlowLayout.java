    ...
    public void setList(List<String> list) {
        for (String text : list) {
            ...
            MarginLayoutParams layoutParams =
                    new MarginLayoutParams(LayoutParams.WRAP_CONTENT, SizeUtils.dp2px(20));
            layoutParams.leftMargin = SizeUtils.dp2px(10);
            layoutParams.bottomMargin = SizeUtils.dp2px(10);
            textView.setBackgroundResource(R.drawable.shape_search_histroy_item_bg);
            ...
            textView.setOnClickListener(v -> {
                if (mItemOnClickListener != null)
                    mItemOnClickListener.onItemOnClick(text);
            });
            addView(textView);
        }
    }
