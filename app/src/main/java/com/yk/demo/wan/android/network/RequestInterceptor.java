...
import com.yk.demo.wan.android.utils.CharacterHandler;
import com.yk.demo.wan.android.utils.DmndUtils;
import com.yk.demo.wan.android.utils.UrlEncoderUtils;
...
//        String data = httpResult;
        BaseResponse baseResponse = GsonUtils.fromJson(bodyString, BaseResponse.class);
        if (baseResponse!=null){
            if (baseResponse.getCode() != 0) {
                ToastUtils.showShort(baseResponse.getMsg());
                if (baseResponse.getCode() == 401 || baseResponse.getMsg().contains("token失效")) {
                    DmndUtils.logoutAndLogin();
                }
//                throw new DmndServiceException(baseResponse.getMsg());
            }
        }
